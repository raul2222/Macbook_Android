package es.upv.practicaprocesadob;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override public void onStart() { super.onStart(); adaptador.startListening();
    }
    @Override public void onStop() { super.onStop(); adaptador.stopListening();
    }
